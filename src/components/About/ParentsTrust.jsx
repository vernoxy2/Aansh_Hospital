  ...
  return (
    <div>
      <div className="w-full flex flex-col lg:flex-row items-center justify-center py-12 px-4 lg:px-20">
        {/* Heart-shaped image */}
        <div className="flex-shrink-0 flex justify-center w-full lg:w-1/2 mb-8 lg:mb-0">
          <img
            src={familyHeart}
        ...
        {/* Text content */}
        <div className="flex-1 flex flex-col items-center lg:items-start justify-center text-center lg:text-left px-2">
