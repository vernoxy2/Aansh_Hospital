...
import headerFaqsImg from "../../assets/headerFaqsImg.png";
...
const FaqHeader = () => {
  return (
    <section
      ...
      style={{ backgroundImage: `url(${headerFaqsImg})` }}
    >
      ...
      <div className="absolute container sm:mb-20 inset-0 flex items-center justify-start ">
        <div className="space-y-1 md:space-y-5">
          ...
          <p className="font-semibold leading-tight text-[9px] lg:text-xl text-primary w-1/2 lg:w-2/5">
            Cozy hospital info corner with brochures, digital screen, plush
            toys, and pastel decor, offering calm, organized support for
            parents’ questions.
          </p>
        </div>
      </div>
