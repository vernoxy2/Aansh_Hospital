...
const Child = () => {
  ...
  return (
    <div className="relative w-full bg-white overflow-hidden py-12 px-4 flex flex-col items-center min-h-[400px]">
      {/* Top Heading */}
      <h1 className="w-full text-center text-[#A82682] text-2xl md:text-3xl lg:text-4xl font-bold mb-12" data-aos="zoom-in">
      ...
      <div className="relative flex flex-col lg:flex-row items-center justify-between w-full container xl:gap-44 mx-auto ">
        ...
        {/* Right: Doctor image */}
        <div className="flex-1 flex justify-center items-center w-full mt-12 lg:mt-0" data-aos="fade-left">
          <img
            src={doctor}
